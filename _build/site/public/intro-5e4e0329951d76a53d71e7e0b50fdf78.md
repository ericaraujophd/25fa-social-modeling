...
This website is the main source of information for the course. You will find the syllabus, schedule, and all the course materials here. The course is built using [Jupyter Book](https://jupyterbook.org/), which allows us to create interactive content that you can explore.
